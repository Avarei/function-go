...
# replacing all instances of function-go with the
...
# Replace function-go with the name of your function
# in go.mod
perl -pi -e s,function-go,"$1",g go.mod
# in fn.go
perl -pi -e s,function-go,"$1",g fn.go
# in examples
perl -pi -e s,function-go,"$1",g example/*
